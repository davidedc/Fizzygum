...
[`docs/occlusion-culling-plan.md`](occlusion-culling-plan.md). This feature is orthogonal to and
composes with [`docs/interactive-render-perf-A-C-plan.md`](interactive-render-perf-A-C-plan.md):
