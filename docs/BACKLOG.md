...
### The build-and-packaging program (`build-arc-1…5-*.md`, authored 2026-07-28 — arcs 1-4 in `archive/`, arc 5 still in `plans/`)
Five plans, filenames numbered by execution order; program table + completion doctrine in
`archive/build-arc-4-dynamic-parts-plan.md` §0.1/§0.2. Arcs 1-4 DONE; arc 5 not started.
