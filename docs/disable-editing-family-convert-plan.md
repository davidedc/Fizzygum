...
**The system invariant** (canonical: `docs/layout-system-architecture-assessment.md` §2.2/§2.7): every
...
**The 2026-07-04 history (the hover-resync session — full record: `docs/hover-resync-after-flush-plan.md`
...
The three comment updates listed in §3, plus: `docs/layout-system-architecture-assessment.md` needs NO
