...
arc — this plan. Full prior history: `docs/end-of-cycle-flush-inventory.md` (its **2026-06-27 ✅ CAMPAIGN COMPLETE
...
settled geometry; it must not schedule or mutate layout.** The deferred-layout OVERVIEW (`docs/deferred-layout-OVERVIEW.md`)
and `docs/layout-system-architecture-assessment.md` (§2.7, the flush/coalescing model) are the canonical homes. The
end-of-cycle inventory (`docs/end-of-cycle-flush-inventory.md` §11) already flagged a *sibling* curiosity — a freefloating
...
- **Companion docs:** `docs/end-of-cycle-flush-inventory.md` (§11 = the sibling paint-time freefloating re-fit; the
  CAMPAIGN-COMPLETE banner). `docs/layout-system-architecture-assessment.md` §2.7 (flush + coalescing model).
  `docs/deferred-layout-OVERVIEW.md` (the render/layout separation + family-5). `Fizzygum-tests/DETERMINISM.md` (byte-exact
