...
Read, in order:
1. `Fizzygum/docs/deferred-layout-OVERVIEW.md` — canonical record of the layout engine + the "deferred-layout"
   campaign that produced it. **Authoritative on any conflict.**
2. `Fizzygum/docs/layout-system-architecture-assessment.md` — the architectural assessment this survey extends
...
1. `Fizzygum/docs/end-of-cycle-flush-inventory.md` — the report: Q1–Q6 answered, the inventory table
...
3. (Optional) `Fizzygum/docs/end-of-cycle-self-settle-conversion-plan.md` — a follow-on plan for Rungs 1–2, only
