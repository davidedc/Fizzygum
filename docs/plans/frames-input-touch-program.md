...
- Plan 3.5 command-panel unification (T1 as expanded) — RULED 2026-08-24: its own arc after
  Plan 3, before Plan 4 (see the T1 row).
- Plan 4 gesture grammar + finger harness — not authored (author when Plan 3.5 closes).
...
| 3 | `docs/archive/single-geometry-visual-wave-plan.md` | when Plan 2 closes | The bar/dock metrics it retunes are Plan 1's output. |
...
| 4 | `docs/plans/gesture-grammar-and-finger-harness-plan.md` | when Plan 3.5 closes | Cites the `PointerInputEvent` family (Plan 2) and captures at final geometry (Plans 3/3.5). |
