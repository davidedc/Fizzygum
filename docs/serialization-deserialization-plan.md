...
- Historical design notes: `docs/god-class-decomposition-plan.md:106` (the `$EXTERNAL` rule) and
...
(NB `docs/widget-identity-decoupling-plan.md` is about `instanceof`-style type tests, *not* this
...
- the traversal *contract* (own-props, cycle table, external-widget test against
  ...
  `docs/serialization-duplication-reference.md`** covering serialization, deserialization AND
...
- **New** `src/serialization/` classes: `SerializationError` (fields per §4.7),
  ...
  plus the dedicated reference doc `docs/serialization-duplication-reference.md` (§4.6) and its
...
6. **Documentation placement** (feedback 2026-07-04): all ser/deser/duplication documentation
   lives in ONE dedicated reference doc, `docs/serialization-duplication-reference.md`;
...
- **Phase 1 — Scaffolding (framework, behaviour-neutral) — LANDED 2026-07-04 (not yet committed).**
  ...
  New content-bearing doc `docs/serialization-duplication-reference.md` (documents the existing
