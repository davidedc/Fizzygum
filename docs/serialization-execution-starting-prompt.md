...
1. `Fizzygum/docs/serialization-deserialization-plan.md` — THE plan, fully self-contained. Read
   **§9 (LANDED-STATUS) first** — it records exactly what Phases 0–4 landed, the lessons, and the
   ...
   before editing.
2. `Fizzygum/docs/serialization-duplication-reference.md` — the ONE reference doc for the whole
...
`Fizzygum/docs/serialization-duplication-reference.md`; CLAUDE.md files LINK only, never carry the
content.
