> **ARCHIVED — COMPLETE (2026-07-17 restructure).** CLOSED — committed snapshot of triage-report.md Round 4/4b, all findings actioned or deliberately left
...
lifecycle convention in `docs/tooling/duplicated-code-detection.md` ("when a campaign arc closes, snapshot
...
(`docs/archive/lint-generic-rules-carryover-plan.md`, EXECUTED 2026-07-15). Commits: `2dbf123d` (censuses
...
`@[property]`; serialization drives off name STRINGS). See `docs/architecture/lint-and-static-checks.md` §3b/§3c.
...
- **9 PULL-UP**: the real ones are the 3 `IconicDesktopSystemLinkWdgt` colours (`color_normal:
  ...
  **ZERO of the 10 PULL-UP findings is actionable.** The 3 colours would turn the icons NEAR-WHITE
  ...
  See `docs/archive/census-findings-triage-plan.md` Phase 2. **Do not re-open.**
