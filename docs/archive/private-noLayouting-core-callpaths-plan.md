> **ARCHIVED — COMPLETE (2026-07-17 restructure).** EXECUTION STATUS 2026-06-23: chains 1&2 DONE; optional §5 lint + Plan 2 (settle-tier rename) remain Chains 1&2 done; §5/Plan-2 residuals tracked in docs/BACKLOG.md.
