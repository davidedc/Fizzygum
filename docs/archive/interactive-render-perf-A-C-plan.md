> **ARCHIVED — COMPLETE (2026-07-17 restructure).** A + C1 LANDED 2026-07-09; C2 retired into spreadsheet follow-on F5 (2026-07-17).
...
`docs/plans/runtime-performance-optimization-plan.md` (§8 ledger).
...
> `docs/plans/runtime-performance-optimization-plan.md`. **No tests-repo change.**
...
out with pixel receipts and scheduled FIRST in `docs/plans/dataflow-engine-implementation-plan.md`
...
ledger of `docs/plans/runtime-performance-optimization-plan.md`.
...
Record each landing in `docs/plans/runtime-performance-optimization-plan.md` §8 ledger (date, item,
