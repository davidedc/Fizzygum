> **ARCHIVED — COMPLETE (2026-07-17 restructure).** DONE 2026-07-01 — 6 of 9 re-visits eliminated byte-exact; 3 nested-window convergences BANKED irreducible
...
- **Binding prior verdicts (READ before attacking):** `docs/archive/proper-layouts-4.4-ordered-downwalk-plan.md §8` (the
  FALSIFIED-paths record), `docs/archive/proper-layouts-4.2-structural-arrange-plan.md`, `docs/archive/proper-layouts-geometry-seam-removal-plan.md`
