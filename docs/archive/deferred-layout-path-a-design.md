> **ARCHIVED — COMPLETE (2026-07-17 restructure).** HISTORICAL — Path A (pending-aware accessors) FALSIFIED 2026-06-19/20; do not revive.
...
**Companion to `docs/archive/softwrap-deferred-layout-conversion-plan.md`.** That doc establishes the model
