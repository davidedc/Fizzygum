> **ARCHIVED — COMPLETE (2026-07-17 restructure).** Executed — confirmed via source (_moveToDeferredSettle / deferredSettlingEnabled shipped); no completion banner in the doc itself.
...
- **Historical docs are records:** `docs/tooling/coalescing-measurement.md`, the
