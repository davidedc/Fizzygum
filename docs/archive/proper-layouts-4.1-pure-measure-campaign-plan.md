> **ARCHIVED — COMPLETE (2026-07-17 restructure).** Stages 0/A/B/C/D COMPLETE 2026-06-28 (committed-held); confirmed by proper-layouts-4.2's own status banner
...
- **Authoritative analysis (READ):** `docs/archive/layout-system-architecture-assessment.md` §2.4/§2.5/§4.1/§4.2 (owner WIP —
