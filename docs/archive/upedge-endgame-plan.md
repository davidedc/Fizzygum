> **ARCHIVED — COMPLETE (2026-07-17 restructure).** V2 ARC CLOSED 2026-07-17 — all §8 criteria met, revisit baseline now EMPTY; pushed per project ledger
...
`revisit-baseline.json`). Authorities: `docs/archive/sizing-model-unification-plan.md` §9.7-Q/§9.8/§6 ·
`docs/archive/layout-system-architecture-assessment.md` §2.3/§2.6 + the rules section ·
`docs/archive/deferred-layout-residuals-audit.md` (fam 4) · `docs/archive/window-content-negotiation-residual-plan.md`
