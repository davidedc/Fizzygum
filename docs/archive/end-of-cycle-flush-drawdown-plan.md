> **ARCHIVED — COMPLETE (2026-07-17 restructure).** Playbook half of the end-of-cycle campaign; campaign complete 2026-06-27.
...
`Fizzygum/docs/archive/end-of-cycle-flush-inventory.md`, `end-of-cycle-catalog.md`, `end-of-cycle-self-settle-conversion-plan.md`.
