> **ARCHIVED — COMPLETE (2026-07-17 restructure).** EXECUTED + PUSHED 2026-06-27 — implemented exactly as designed
...
- **Prior-arc records (read for context):** memory `fizzygum-paint-readonly-caret-resync` (the caret in-place-settle +
  ...
  `Fizzygum/docs/archive/deferred-layout-OVERVIEW.md` §11 (the immediate-mutator seam + the determinism-exempt in-pass enqueue).
