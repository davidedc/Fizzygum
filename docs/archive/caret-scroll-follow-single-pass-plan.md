> **ARCHIVED — COMPLETE (2026-07-17 restructure).** DONE 2026-07-01; caret scroll-follow settle re-visits 372→0, byte-exact gauntlet 165/165, zero recaptures.
...
## §6 — References
- **`docs/archive/proper-layouts-geometry-seam-removal-plan.md`** §5 Stage 6 — the arc that produced the current state (cap →
