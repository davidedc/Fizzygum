> **ARCHIVED — COMPLETE (2026-07-17 restructure).** Reusable playbook distilled from the completed InspectorMorph→InspectorWdgt arc; the campaign it documents is done.
