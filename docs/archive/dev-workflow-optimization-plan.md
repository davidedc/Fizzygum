> **ARCHIVED — COMPLETE (2026-07-17 restructure).** ARC COMPLETE 2026-07-12 16:45 (P1-P7 all closed; P8 skipped as optional).
...
- **2026-07-12 ~15:00 — P7 docs a–g LANDED** (zero-risk, done while the P1 matrix ran):
  ...
  `@serializationTransients`-vs-DeepCopier asymmetry in `docs/architecture/serialization-duplication-reference.md`
