> **ARCHIVED — COMPLETE (2026-07-17 restructure).** SWAP EXECUTED + VERIFIED 2026-07-04, pending/since owner commit approval.
...
In `docs/archive/layout-system-architecture-assessment.md` (the canonical layout doc — keep its dense style; line
