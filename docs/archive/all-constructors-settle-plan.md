> **ARCHIVED — COMPLETE (2026-07-17 restructure).** DONE 2026-06-30, completion note 2026-07-12; all constructors settle, ctor-build exemption count is zero.
...
dedicated conversion arc `docs/archive/menu-slider-ctor-conversion-plan.md` then CONVERTED all four (byte-identical,
...
- Plans this descends from: `docs/archive/orphan-settledness-plan.md`, `docs/archive/settle-tier-followups-examination-plan.md` (§Topic 4 banked design).
