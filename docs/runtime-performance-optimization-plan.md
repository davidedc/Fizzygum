...
Follow-up **W2** (axis-aligned/1:1 pattern → row-repeat `data32` writes, ~solid speed) planned.
SWCanvas pin now `f127081`. Remaining overall: **W2**, S2 Tier 2, S6b, F1, F3. See §8 ledger + §7.
