...
WorldMorph = (function(_super) {
  ...
  WorldMorph.prototype.initVirtualKeyboard = function() {
    ...
    document.addEventListener("keydown", (function(event) {
      if (event.keyCode === 20) {
        return _this.systemTestsRecorderAndPlayer.takeScreenshot();
      }
    }), false);
...
SystemTestsRepo_SimpleSpeechBubbleTest = (function() {

  function SystemTestsRepo_SimpleSpeechBubbleTest() {}

  SystemTestsRepo_SimpleSpeechBubbleTest.testData = [
    {
      type: "mouseMove",
      mouseX: 158,
      mouseY: 26,
  ...
  return SystemTestsRepo_SimpleSpeechBubbleTest;
...
SystemTestsEvent = (function() {

  function SystemTestsEvent(type, mouseX, mouseY, time, button, ctrlKey, screenShotImageData) {
    this.type = type;
    this.mouseX = mouseX;
    this.mouseY = mouseY;
    this.time = time;
    ...
    this.screenShotImageData = screenShotImageData != null ? screenShotImageData : '';
    console.log(this.type + " " + this.mouseX + " " + this.mouseY + " " + this.time + " " + this.button + " " + this.ctrlKey + " " + hashCode(this.screenShotImageData));
  }

  return SystemTestsEvent;
...
SystemTestsRecorderAndPlayer = (function() {
  ...
  SystemTestsRecorderAndPlayer.prototype.addMouseMoveEvent = function(pageX, pageY) {
    ...
    this.eventQueue.push(new SystemTestsEvent("mouseMove", pageX, pageY, currentTime - this.lastRecordedEventTime, null, null));
  ...
  SystemTestsRecorderAndPlayer.prototype.addMouseDownEvent = function(button, ctrlKey) {
    ...
    currentTime = new Date().getTime();
    this.eventQueue.push(new SystemTestsEvent("mouseDown", null, null, currentTime - this.lastRecordedEventTime, button, ctrlKey, null));
    return this.lastRecordedEventTime = currentTime;
  };
  ...
  SystemTestsRecorderAndPlayer.prototype.addMouseUpEvent = function() {
    ...
    currentTime = new Date().getTime();
    this.eventQueue.push(new SystemTestsEvent("mouseUp", null, null, currentTime - this.lastRecordedEventTime, null, null, null));
    return this.lastRecordedEventTime = currentTime;
  };
  ...
  SystemTestsRecorderAndPlayer.prototype.takeScreenshot = function() {
    ...
    currentTime = new Date().getTime();
    this.eventQueue.push(new SystemTestsEvent("takeScreenshot", null, null, currentTime - this.lastRecordedEventTime, null, null, this.worldMorph.fullImageData()));
    return this.lastRecordedEventTime = currentTime;
  };

  SystemTestsRecorderAndPlayer.prototype.compareScreenshots = function(expected) {
    if (expected === this.worldMorph.fullImageData()) {
      return console.log("PASS - screenshot as expected");
    } else {
      return console.log("FAIL - screenshot is different from expected");
    }
  };
