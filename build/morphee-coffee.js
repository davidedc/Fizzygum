...
Morph = (function(_super) {
  ...
  Morph.prototype.morphPropertThatNoOtherObjectOwns = "this property is exposed to all the subclasses but only via their prototype chain. It should appear blue in the inspector for the PenMorph object";
...
InspectorMorph = (function(_super) {
  ...
  function InspectorMorph(target) {
    ...
    this.markOwnershipOfProperties = false;
  ...
  InspectorMorph.prototype.buildPanes = function() {
    var attribs, ctrl, ev, property, targetOwnMethods,
      _this = this;
    attribs = [];
    property = void 0;
    ctrl = void 0;
