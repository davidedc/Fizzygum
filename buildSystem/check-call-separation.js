...
const BASELINE_U_QUERY = 132;      // 152 at rule birth; T2 deleted the vestigial buildSubwidgets hooks; T5's renames took 1 more off; tightened 150 -> 148 on 2026-07-15 to lock in a gain a later arc had already banked (fg critique surfaced it); 148 -> 147 on 2026-07-22 with the invalidation-privacy rename (the changed family left the public-query census); 147 -> 143 on 2026-07-22 with the extent+move pair fusion (_applyBounds/setBounds one-shots); 143 -> 132 on 2026-07-30 banking gains arc 3 had already landed without tightening (it re-homed the test-only members out of src into Fizzygum-tests' *TestSupport classes and retired the »>> region mechanism, deleting whole experimental classes — both take methods out of this census), surfaced by this gate's own NOTE
