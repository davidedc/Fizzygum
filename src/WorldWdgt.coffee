...
class WorldWdgt extends PanelWdgt
  ...
  # (PopUpWdgt._justDroppedNoSettle -> pinPopUp, inside the drop's settle). Separate keeps the menu path's per-popup
  ...
  # NON-settling variant for the drop path (PopUpWdgt._justDroppedNoSettle -> pinPopUp, inside the drop's
