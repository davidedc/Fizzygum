...
# opened from the examples folder. One of the per-app WindowedApp
...
# live in AppCatalog, not here (see WindowedApp's header). The
...
class SampleSlideApp extends WindowedApp
