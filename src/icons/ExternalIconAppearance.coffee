class ExternalIconAppearance extends IconAppearance
  ...
  paintFunction: (context) ->
    ...
    #// arrow in Drawing
    context.beginPath()
    context.moveTo 3.44, 43.3
    context.lineTo 39.64, 43.3
    context.lineTo 39.64, 24.48
    context.lineTo 73.62, 49.22
    context.lineTo 39.64, 73.92
    context.lineTo 39.64, 55.12
    context.lineTo 3.44, 55.12
    context.lineTo 3.44, 43.3
    context.closePath()
    context.fillStyle = fillColor.toString()
    context.fill()
