...
class StringMorph3 extends Morph
  ...
  # used, say, on a text in a ScrollFrame.
  isScrollable: true
  ...
  #
  fittingSpecTextBoxFittingTextTightOrLoose: FittingSpecTextBoxFittingTextTightOrLoose.LOOSE
  fittingSpecTextBoxFittingTextWhichDimensionAdjusts: FittingSpecTextBoxFittingTextWhichDimensionAdjusts.HEIGHT_ADJUSTS_TO_WIDTH
  #
  ...
  togglefittingSpecWhenBoundsTooSmall: (menuItemThatTriggered) ->

    # something here about checking or un-checking the text
    # in the menuitem
    menuItemThatTriggered.toggleTick()
