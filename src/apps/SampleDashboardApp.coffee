...
class SampleDashboardApp extends IconicDesktopSystemWindowedApp
  ...
  buildWindow: ->
    ...
    container._applyExtentAndNotify new Point 725,556

    scatterPlot = new WindowWdgt nil, nil, new PlotWithAxesWdgt(new ExampleScatterPlotWdgt), true, true
    scatterPlot._applyMoveToAndNotify container.position().add new Point 19, 86
    scatterPlot._applyExtentAndNotify new Point 200, 200
    ...
    functionPlot._applyMoveToAndNotify container.position().add new Point 251, 86
    functionPlot._applyExtentAndNotify new Point 200, 200
    ...
    barPlot._applyMoveToAndNotify container.position().add new Point 19, 327
    barPlot._applyExtentAndNotify new Point 200, 200
    ...
    plot3D._applyMoveToAndNotify container.position().add new Point 491, 327
    plot3D._applyExtentAndNotify new Point 200, 150
    ...
    worldMap._applyMoveToAndNotify container.position().add new Point 464, 128
    worldMap._applyExtentAndNotify new Point 240, 125
    container.add worldMap
    worldMap.rememberFractionalSituationInHoldingPanel()

    speechBubble1 = new SpeechBubbleWdgt "online"
    speechBubble1._applyMoveToAndNotify container.position().add new Point 506, 123
    speechBubble1._applyExtentAndNotify new Point 66, 42
    ...
    speechBubble2._applyMoveToAndNotify container.position().add new Point 590, 105
    speechBubble2._applyExtentAndNotify new Point 66, 42
    ...
    dashboardTitle._applyMoveToAndNotify container.position().add new Point 161, 6
    dashboardTitle._applyExtentAndNotify new Point 403, 50
    ...
    slider1._applyMoveToAndNotify container.position().add new Point 491, 484
    slider1._applyExtentAndNotify new Point 201, 24
