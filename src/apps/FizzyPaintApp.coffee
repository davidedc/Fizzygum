...
# the base owns the launcher/opener + launch, and openWindowWith does the window wrap.
class FizzyPaintApp extends IconicDesktopSystemWindowedApp

  title: "Draw"
  buildIcon:    -> new PaintBucketIconWdgt
  buildWindow:  -> @openWindowWith (new ReconfigurablePaintWdgt), (new Point 460, 400), (new Point 174, 114)
