...
Node::init = (parent, childrenArray) ->
...
Node::toString = ->
  "a Node" + "[" + @children.length.toString() + "]"
...
Node::addChildFirst = (aNode) ->
  @children.splice 0, null, aNode
  aNode.parent = this

Node::removeChild = (aNode) ->
  idx = @children.indexOf(aNode)
...
Node::parentThatIsA = (constructor) ->
...
Node::parentThatIsAnyOf = (constructors) ->
